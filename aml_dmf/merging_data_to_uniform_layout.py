# As the provided dataset is not in a useable format, this .py module merges the data into a structured format. After a check of the headline to a reference file, the startstop behaviour is detected. The regarding module returns the timeline, where constant behaviour is detected. The sensor data is then merged accordingly. For more information please refer to the readme file.
